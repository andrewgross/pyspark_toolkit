...
from pyspark_toolkit.helpers import chars_to_int, pad_key, sha2_binary
...
def test_sha2_binary():
    ...
    pyspark_result = run_column(definition, a, "")
    assert pyspark_result == b'\x18_\x8d\xb3"q\xfe%\xf5a\xa6\xfc\x93\x8b.&C\x06\xec0N\xdaQ\x80\x07\xd1vH&8\x19i'
